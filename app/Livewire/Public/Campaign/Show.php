...
class Show extends Component
{
    ...
    private function formatItem(CampaignItem $item): array
    {
        ...
        return [
            ...
            'received_quantity' => $this->formatQuantity($item->received_quantity),
            ...
            'promised_progress' => $requiredQuantity > 0 ? (int) min(($promisedQuantity / $requiredQuantity) * 100, 100) : 0,
            'received_progress' => $requiredQuantity > 0 ? (int) min(($item->received_quantity / $requiredQuantity) * 100, 100) : 0,
