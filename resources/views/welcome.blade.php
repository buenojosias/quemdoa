...
<body class="font-sans antialiased text-slate-900 bg-white selection:bg-teal-100 selection:text-teal-900">
    ...
    <header class="w-full px-6 md:px-14 py-6 flex items-center justify-between">
        ...
        <nav class="hidden md:flex items-center gap-8">
            <a href="#recursos" class="text-sm font-semibold text-slate-600 hover:text-slate-900 transition">Recursos</a>
            <a href="#como-funciona" class="text-sm font-semibold text-slate-600 hover:text-slate-900 transition">Como funciona</a>
        </nav>
        <div class="flex items-center gap-6">
            ...
            <a href="{{ route('register') }}" class="bg-teal-600 text-white text-sm font-semibold px-5 py-2.5 rounded-full hover:bg-teal-700 transition shadow-sm">Criar conta</a>
        </div>
    </header>
    ...
    <section class="w-full my-6 flex flex-col sm:flex-row sm:items-center gap-6 overflow-hidden">
        <div class="flex-1 pl-6 pr-6 md:pl-14 space-y-4">
            ...
            <h1 class="text-4xl md:text-5xl font-extrabold text-slate-900 leading-[1.1] tracking-tight">
                Menos bagunça no grupo, <br class="hidden lg:block" />
                <span class="text-teal-600">mais união</span> na missão.
            </h1>
    ...
    <section class="bg-slate-50 py-10 border-y border-slate-100">
        <div class="container mx-auto px-6 flex flex-col md:flex-row items-center justify-center gap-5">
            ...
            <div class="text-center md:text-left">
                ...
                <p class="text-sm text-slate-500 font-medium">Seja um dos primeiros a usar e fique por dentro de todas as novidades.</p>
    ...
    <!-- Features Section -->
    <section id="recursos" class="w-full px-6 md:px-14 py-18 text-center">
    ...
    <section id="como-funciona" class="w-full px-6 md:px-14 py-8 bg-white relative">
        ...
        <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-8 mb-12">
            ...
            <div class="md:col-span-2 lg:col-span-1">
                ...
                <div class="flex items-center gap-4 text-slate-400">
                    ...
                    <a href="https://www.instagram.com/quemdoa" target="_blank" class="hover:text-teal-600 transition">
            ...
            <div class="lg:col-span-1">
                ...
                <ul class="space-y-3.5 text-sm text-slate-500 font-medium">
                    <li><a href="#recursos" class="hover:text-teal-600 transition">Recursos</a></li>
                    <li><a href="#como-funciona" class="hover:text-teal-600 transition">Como funciona</a></li>
